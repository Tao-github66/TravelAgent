...
<?php
	...
	$table = "customers";
	$custId = mysql_update_array($table, $customer_array, $_POST["CustomerId"]);
	...
	//$mail->Body='<h2>$num</h2>'
	//$mail->Body='<h1 align="center">Thank yoo!</h1>'
	$mail->Body='<h1 align="center">You booking is confirmed</h1><br/><h2align="center">Your Booking No. is '.$num.'</h2><br/><h1 align="center">Thank youuuuuu!</h1><br/>';
